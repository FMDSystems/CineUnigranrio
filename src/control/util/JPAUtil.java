...
public class JPAUtil
{
	 ...
	 * objetivo È criar apenas 1 objeto EntityManager para cada Thread, de forma
	...
	public static EntityManager getEntityManager()
	{
		...
		// caso ainda n„o tenha sido criado, cria um novo e guarda reutilizaÁ„o
		if (retorno == null)
		{
